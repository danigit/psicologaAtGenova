...
var aboutMe = '<div class="container">'
    ...
    + "target='_blank' class='blue-text'>Centro di Psicoterapia 2.0</a> seguo adolescenti e adulti nell\'accompagnamento "
...
var eventi = '<div class="container">'
    + '<div class="row">'
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12 text-center display-4 page-title philosopher-font blue-text">'
    + 'Eventi in programma'
    + '</div></div> '
    ...
    + '<img src="../psicologaAtGenova/img/default/prossimi_eventi.jpg" class="blue-border"><br><br>'
    + '</div></div> '
    + '<div class="row" >'
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12 open-font font-large"> '
    ...
    + "<p>A breve tutte le informazioni!</p><br><br>"
    + '</div></div>'
    + '<div class="row">'
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12 text-center display-4 page-title philosopher-font blue-text">'
    + 'Eventi passati'
    ...
    + "<p>Presso il <a href='http://www.genovapsicologia.it' target='_blank' class='blue-text'><b>Centro di "
    + "Psicoterapia 2.0</b></a> (Via XXV Aprile 8/6 – Genova), in collaborazione con la "
    + "<a href='http://www.facebook.com/milviaspinettapsicologa/' target='_blank' class='blue-text'><b>dott.ssa "
    + "Milvia Spinetta</b></a>, vengono proposti al pubblico due incontri per conoscere, sfatare qualche mito, e "
    + "cominciare ad affrontare i due disturbi più diffusi della nostra epoca: l\’<b>ansia</b> e la <b>depressione</b>.</p>"
    + "<br><br><p>\“<b>La vita mi stressa!</b>\” – Conoscere e affrontare l\’ansia</p><br>"
    + '<p>SABATO 3 MARZO vi parlerò di cosa è l\’ansia dal punto di vista della psicologia clinica, vedremo che ruolo '
    + 'ha rispetto agli altri stati emotivi, conosceremo i vari disturbi d’ansia e l\’approccio alla cura attraverso '
    + 'l\’Analisi Transazionale.</p><br>'
    + '<p>Durante l\’incontro, per chi ne avrà piacere, verranno distribuiti test di autovalutazione relativi agli '
    + 'argomenti trattati e verrà proposta una breve esercitazione di mindfulness guidata per l\’osservazione delle '
    + 'proprie emozioni.</p><br><br>'
    + "<p>\“<b>Uff... Che fatica la vita...</b>\” – Conoscere e affrontare la depressione</p><br>"
    + '<p>SABATO 7 APRILE la collega dott.ssa Spinetta affronterà il tema della depressione. Attraverso l’esemplificazione '
    + 'di un caso clinico verranno illustrati i processi psicologici che sottendono questo disturbo, e il modo in cui '
    + 'viene trattato attraverso la CBT.</p><br>'
    + '<p>Chi avrà piacere potrà presentare riflessioni personali su argomenti specifici introdotti dalla dottoressa per '
    + 'discutere e chiarirne alcuni aspetti, e compilare i test psicologici che verranno proposti.<br><br>'
    + '<p class="blue-text" ">Considerato lo spazio limitato, è richista l\’iscrizione per mail (simona.bettoli@gmail.com) '
    + 'o sms (333 873.72.31), specificando la/le data/e cui si intende partecipare. Vi aspettiamo!</p><br><br>'
    + '</div></div>'
...
var transactional = '<div class="container">'
    + '<div class="row">'
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12 text-center display-4 page-title philosopher-font blue-text">'
    ...
    + '<div class="row">'
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12">'
    + '<img src="../psicologaAtGenova/img/default/psicoterapia_analitico_transazionale.jpg" class="blue-border"><br><br>'
    + '</div></div> '
    + '<div class="row"> '
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12 open-font font-large"> '
...
var training = '<div class="container">'
    ...
    + '<img src="../psicologaAtGenova/img/default/training_autogeno.jpg" class="blue-border"><br><br>'
    + '</div></div> '
    + '<div class="row"> '
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12 open-font font-large"> '
...
var relax = '<div class="container">'
    ...
    + '<div class="row">'
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12" id="analisi-image">'
    + '<img src="../psicologaAtGenova/img/default/psi_benessere.jpg" class="blue-border"><br><br>'
    + '</div></div> '
    + '<div class="row"> '
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12 open-font font-large"> '
...
var technique = '<div class="container">'
    ...
    + '<div class="row">'
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12" id="analisi-image">'
    + '<img src="../psicologaAtGenova/img/default/immagination.jpg" class="blue-border"><br><br>'
    + '</div></div> '
    + '<div class="row"> '
    + '<div class="col-12 col-lg-12 col-md-12 col-sm-12 open-font font-large"> '
